...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p>
            Best Text to image generator</p>
    ...
    className='flex flex-wrap justify-center mt-16 gap-3'>
        {Array(6).fill('').map((items,index)=>(
          <motion.img className='rounded hover:scale-105 transition-all duration-300 cursor-pointer mx-sm:w-10'  whileHover={{scale:1.05}}
